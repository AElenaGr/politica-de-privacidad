// src/components/ActosOficiales.js
import React from 'react';
import '../styles/actosOficiales.css';

const ActosOficiales = () => {
  return (
    <section className="actos-oficiales">
      ...
      <h2>Dirección de Actos Oficiales y Culturales</h2>
